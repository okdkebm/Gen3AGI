...
func TestGetSecretPatterns_PatternCompilation(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			name: "OAuth",
			config: &Config{
				OAuthGoogleClientID:     "test-google-oauth-client-id",
				OAuthGoogleClientSecret: "test-google-oauth-client-secret",
				OAuthGithubClientID:     "test-github-oauth-client-id",
				OAuthGithubClientSecret: "test-github-oauth-client-secret",
			},
		},
		{
			name: "Database",
